...
struct Player
{
    ...
    {
        goals_scored++;
        PlayerScoredData ps{ name, goals_scored }; // generate the data to be posted on the signal
        game.events(&ps); // posting event
    }
};
...
struct Coach
{
        ...
        : game(game)
    {
        ...
        game.events.connect([](EventData* e) // subscribe to events happened in the game
            {
