...
// use extension by using inheritance (such as combinators)
...
struct ProductFilter
{
    ...
    // adding this binary incompatibility by adding another interface member to product is not great
...
// sepecification pattern. enterprise pattern (working with data)
